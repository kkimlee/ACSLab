...
#################################
# Path, File List
path = "E:\\frames_yaw_-20\\"
# path = './frames_110_3bit/'
file_list = os.listdir(path)
f = open("yaw_-20_anal.txt", 'w')
...
for data_pos in range(800,970,10):
    ...
    pos = [900,600,970]
    pIdx = 0
    for file in file_list[128:131]:
        img = cv2.imread(path + file)
        # crop
        img_crop = img[22:1008, 1211:1224, :]
